...
import { z } from 'zod';
import { getJobForJobSeekerFromId } from '@/app/_actions/get-job-for-job-seeker-from-id';
import { updateJobForJobSeeker } from '@/app/_actions/update-job-for-job-seeker';
...
export function JobInformation({ jobId }: { jobId: string }) {
  ...
  useEffect(() => {
    async function fetchData() {
      const data = await getJobForJobSeekerFromId({ id: jobId });
      if (data) {
